...
if test_mae > train_mae and test_r2 < train_r2:
    print('Model may be overfitting, as training error is lower than test error.')
...
forecast[['ds', 'yhat', 'yhat_lower', 'yhat_upper']].to_csv('forecast_ca_enr_m.csv', index=False)